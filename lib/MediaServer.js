 ...
 * @param {Boolean} flag
 */
MediaServer.enableWarning = function(flag)
{
	//Set flag
	...
	/** @type {string} */ mediaId)
{
	...
	//Add track to stream
	incomingStream.addTrack(/** @type {any} */ (incomingStreamTrack));
	//Done
	return incomingStream;
}

MediaServer.createFrameDispatchCoordinator = function(/** @type {Number} */ updateRefsPacketLateThresholdMs,
							/** @type {Number} */ updateRefsStepPacketEarlyMs)
{
	return SharedPointer(new Native.FrameDispatchCoordinatorShared(updateRefsPacketLateThresholdMs, updateRefsStepPacketEarlyMs));
}
